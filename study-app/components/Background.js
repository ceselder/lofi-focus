...
export default function Background()
{
    ...
    return (<div>
        ...
        {controlState.transitionPlaying && (<video key={controlState.transitionPlaying} muted className='absolute -z-20 top-0 left-0 w-full h-full object-cover' autoPlay loop>
            <source src='mp4/filters/transition.mp4' type='video/mp4' />
        </video>)}
        
        <video key={controlState.background} muted className='absolute -z-30 top-0 left-0 w-full h-full object-cover' autoPlay loop>
